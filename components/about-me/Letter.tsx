      ...
      <div className="bg-letter-top shadow-letter-top relative -top-3 z-10 -rotate-1 rounded-lg lg:rotate-2 lg:rounded-xl">
        <article className="space-y-4 p-4 text-base text-white/80 lg:space-y-5 lg:p-5 lg:px-24 lg:py-14 lg:text-2xl">
          ...
          <p>
            ...
            from nothing, or solving a complex problem that&apos;s been nagging
            at you for days. That rush of satisfaction when your code finally
            runs smoothly—that&apos;s how coding used to feel all the time for
            me.
          </p>
          ...
          <p>
            ...
            TheLostKingdom on FTM. We&apos;re talking millions in sales and
            thousands in trading volume. It was exhilarating, but it came at a
            cost.
          </p>
          <p>
          ...
          <p>
            Now, I&apos;m no longer afraid to share my story. I&apos;m a Senior
            Full-Stack developer, yes, but I&apos;m also a shaman, a time
            traveler, a hacker, a tinker, a delusional optimist, a truth seeker,
            a data broker, an AI researcher, and a polymath.
          </p>
          <p>
            To everyone out there feeling lost or burnt out: there&apos;s hope.
          </p>
