...
export default function HeroCTA() {
  return (
    <div className="relative z-40 mt-20 grid grid-cols-1 lg:grid-cols-2 xl:mx-auto xl:max-w-[1440px]">
      <div className="grid grid-cols-1 items-center justify-center gap-4 px-2 lg:gap-2 lg:pl-10 xl:pl-0">
        <div className="mx-auto h-10 w-80 rounded-full bg-purple-800 lg:mx-0 lg:h-12 xl:h-14 xl:w-96">
        ...
        <div className="flex justify-center gap-4 lg:justify-start">
          <a
            ...
            className="rounded-full bg-white px-4 py-2 text-sm text-black shadow-cta transition-all hover:bg-transparent hover:text-white hover:shadow-alt-cta xl:px-6 xl:py-3 xl:text-lg"
          >
            Book a Call
          </a>
          <a
            href="https://discord.gg/wzPBjEcn87"
            className="rounded-full px-6 py-2 text-sm text-white shadow-alt-cta transition-all hover:bg-white hover:text-black hover:shadow-cta xl:px-8 xl:py-3 xl:text-lg"
          >
            Join the discord
          </a>
        </div>
